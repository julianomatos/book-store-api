...
async function createClient(req, res, next) {
    try {
        ...
        if (!client.name || !client.password || !client.phone || !client.email || !client.address) {
            throw new Error("Name, Password, Phone, Email e Address são obrigatórios.");
        }        
...
async function updateClient(req, res, next) {
    try {
        let client = req.body;
        if (!client.client_id || !client.name || !client.password || !client.phone || !client.email || !client.address) {
